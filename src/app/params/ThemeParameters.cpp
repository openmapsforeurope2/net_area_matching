...
namespace params{
	...
	ThemeParameters::ThemeParameters()
	{
		...
		_initParameter( AREA_TABLE_INIT_STANDING_WATER_BASE, "AREA_TABLE_INIT_STANDING_WATER_BASE");
		...
		_initParameter( IS_STANDING_WATER_NAME, "IS_STANDING_WATER_NAME" );
		...
		_initParameter( INTERSECTION_AREA_CODE, "INTERSECTION_AREA_CODE" );

		_initParameter( MERGED_AREA_CODE, "MERGED_AREA_CODE" );
		...
		_initParameter( CUT_LINKED_FEATURE_SEPARATOR, "CUT_LINKED_FEATURE_SEPARATOR" );
		...
		_initParameter( AM_LIST_ATTR_JSON, "AM_LIST_ATTR_JSON");
		_initParameter( AM_LIST_ATTR_W, "AM_LIST_ATTR_W");
		_initParameter( AM_LIST_ATTR_SEPARATOR, "AM_LIST_ATTR_SEPARATOR");
	}
